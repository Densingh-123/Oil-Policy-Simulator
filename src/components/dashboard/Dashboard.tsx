...
const Dashboard: React.FC<DashboardProps> = ({ result }) => {
  ...
  return (
    <div className="mt-8 space-y-8">
      <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200 flex justify-between items-center">
        <div>
        ...
        <button
          ...
          className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-xl inline-flex items-center transition duration-150 ease-in-out disabled:bg-green-400 disabled:cursor-not-allowed shadow-lg"
        >
          {isExporting ? (
            <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-lg border border-slate-200">
          <h3 className="text-xl font-semibold text-slate-700 mb-4 flex items-center">
            <i className="fas fa-bullseye-pointer mr-3 text-slate-400"></i>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-200">
         <h3 className="text-xl font-semibold text-slate-700 mb-4 border-b pb-3">
           <i className="fas fa-chart-area mr-2 text-slate-400"></i>
           Economic Forecasts
         </h3>
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {chartConfigs.map(config => (
                <div key={config.key} className="forecast-chart-container">
