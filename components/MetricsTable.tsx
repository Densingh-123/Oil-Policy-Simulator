      ...
      <div className="bg-slate-50 border border-slate-200 p-4 rounded-lg">
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="relative group">
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-60 bg-slate-800 text-white text-xs rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
              {tooltip}
...
const MetricsTable: React.FC<{ metrics: ScenarioMetrics }> = ({ metrics }) => {
  return (
    <div id="metrics-table-container" className="bg-white p-6 rounded-lg shadow-lg border border-slate-200 h-full">
      <h3 className="text-xl font-semibold text-slate-700 mb-4 flex items-center">
        <i className="fas fa-tachometer-alt-fast mr-3 text-slate-400"></i>
        Key Metrics
      </h3>
